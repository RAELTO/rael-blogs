-- ============================================================
-- NBOX Phase 1: Blog to Social Network schema
-- Drops blog-centric tables, creates NBOX tables.
...
-- ---- 5. box_reactions (replaces post_likes) ---------------
-- One reaction type per user per box; can be updated to change type
...
-- ---- 6. box_saves (replaces post_bookmarks) ---------------
...
-- ---- 7. box_comments (replaces comments) ------------------
...
-- ---- 10. Helper: is_banned (recreate after cascade drop) --
...
-- ---- 11. RLS: boxes ----------------------------------------
-- Authenticated users and authors can see published + their own drafts
...
-- Allow changing reaction type (upsert flow from frontend)
...
-- ---- 17. tags: restore insert policy after cascade drop ---
